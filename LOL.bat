...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,2099,5222,5223,8443,%GameFilter% --wf-udp=443,19294-19344,50000-50100,%GameFilter% ^
...
--filter-tcp=2099 --ipset="%LISTS%ipset-lol.txt" --dpi-desync=syndata --new ^
--filter-tcp=5222 --ipset="%LISTS%ipset-lol.txt" --dpi-desync=syndata --new ^
--filter-tcp=5223 --ipset="%LISTS%ipset-lol.txt" --dpi-desync=syndata --new ^
--filter-udp=2099 --ipset="%LISTS%ipset-lol.txt" --dpi-desync=syndata --new ^
--filter-udp=5222 --ipset="%LISTS%ipset-lol.txt" --dpi-desync=syndata --new ^
--filter-udp=5223 --ipset="%LISTS%ipset-lol.txt" --dpi-desync=syndata --new ^
